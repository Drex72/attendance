    ...
    return (
        <svg width="25" height="24" viewBox="0 0 25 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path
                ...
                stroke={pathname.split("/")[1] === link ? "white" : "#868686"}
                stroke-width="1.5"
                stroke-linecap="round"
                stroke-linejoin="round"
            />
            <path
                d="M17.4702 14.4399C18.8402 14.6699 20.3502 14.4299 21.4102 13.7199C22.8202 12.7799 22.8202 11.2399 21.4102 10.2999C20.3402 9.58992 18.8102 9.34991 17.4402 9.58991"
                stroke={pathname.split("/")[1] === link ? "white" : "#868686"}
                stroke-width="1.5"
                stroke-linecap="round"
                stroke-linejoin="round"
            ...
            />
            <path
                d="M9.58997 17.7799C8.17997 18.7199 8.17997 20.2599 9.58997 21.1999C11.19 22.2699 13.81 22.2699 15.41 21.1999C16.82 20.2599 16.82 18.7199 15.41 17.7799C13.82 16.7199 11.19 16.7199 9.58997 17.7799Z"
                stroke={pathname.split("/")[1] === link ? "white" : "#868686"}
                stroke-width="1.5"
                stroke-linecap="round"
                stroke-linejoin="round"
